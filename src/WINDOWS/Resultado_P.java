...
public class Resultado_P extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.setBackground(new java.awt.Color(254, 82, 91));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resultado_P.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Resultado_P().setVisible(true);
            }
        });
    }
